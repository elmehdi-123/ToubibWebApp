...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  reserverRdv(appointement:any){
    ...
    modalRef.result.finally(() =>     console.log(this.account ));
     ...
     appointement.personId = this.account?.person.id;
     appointement.dateRdv = moment(appointement.dateRdv);
     this.appointmentService.update(appointement).subscribe(res => console.log(res) );
     location.reload();
    }
  }
